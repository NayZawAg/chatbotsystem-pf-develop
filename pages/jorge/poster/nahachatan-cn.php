<?php
  ...
  $title = "NahaChatan area poster - Chinese(Simplified) | Tourist Information Chatbot";
  $area="NahaChatan";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 centered">
				<img src=<?php echo getBlobUrlWithSignature('poster/NahaChatan_area_chatbot_poster_cn.jpg') ?> alt=<?php echo $nahachatan_image_alt ?> usemap="#poster_map" width="1145" height="1610" class="img-responsive">
				<map name="poster_map">
