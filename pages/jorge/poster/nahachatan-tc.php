<?php
  ...
  $title = "NahaChatan area poster - Chinese(Traditional) | Tourist Information Chatbot";
  $area="NahaChatan";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 centered">
				<img src=<?php echo getBlobUrlWithSignature('poster/NahaChatan_area_chatbot_poster_tc.jpg') ?> alt=<?php echo $nahachatan_image_alt ?> usemap="#poster_map" width="1145" height="1610" class="img-responsive">
				<map name="poster_map">
				  ...
				  <area shape="rect" coords="930,1603,1135,1587" alt=<?php echo $nahachatan_mail_alt ?> href=<?php echo $mail_link ?>>
				</map>
      </div>
    </div>
  <!-- /col-lg-12 -->
