<?php
  ...
  $title = "Miyoshi area poster - Chinese(Simplified) | Tourist Information Chatbot";
  $area="Miyoshi";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 centered">
				<img src=<?php echo getBlobUrlWithSignature('poster/Miyoshi_area_chatbot_poster_cn.jpg') ?> alt=<?php echo $miyoshi_image_alt ?> usemap="#poster_map" width="1145" height="1610" class="img-responsive">
				<map name="poster_map">
