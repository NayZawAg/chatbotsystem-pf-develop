<?php
  ...
  $title = "Kushiro area poster - Chinese(Simplified) | Tourist Information Chatbot";
  $area = "Kushiro";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 centered">
        <img src=<?php echo getBlobUrlWithSignature('poster/Kushiro_area_chatbot_poster_cn.jpg') ?> alt=<?php echo $kushiro_image_alt ?> usemap="#poster_map" width="1145" height="1610" class="img-responsive">
				<map name="poster_map">
          <area shape="rect" coords="670,545,477,617" alt=<?php echo $kushiro_image_alt ?> href=<?php echo $jorge_link ?>>
				  ...
				  <area shape="rect" coords="676,1590,910,1578" alt=<?php echo $kushiro_mail_alt ?> href=<?php echo $mail_link ?>>
				</map>
      </div>
    </div>
  <!-- /col-lg-12 -->
